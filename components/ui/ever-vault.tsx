  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        ...
        style={style}
      >
        <p className="absolute inset-x-0 h-full font-mono text-xs font-bold break-words whitespace-pre-wrap text-white/[0.8] blur-[1.1px] transition duration-500 dark:text-black/[0.8]">
          {randomString}
        </p>
      </motion.div>
    </div>

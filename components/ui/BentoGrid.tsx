...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento shadow-input row-span-1 flex h-full flex-col justify-between space-y-4 rounded-xl border border-black p-4 transition duration-200 hover:shadow-xl bg-white",
        className,
      )}
    >
      {header}

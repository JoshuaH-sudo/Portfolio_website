...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [aspect-ratio:17/21] w-[300px] md:w-[320px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
